    ...
    <PageWrapper>
      <div style={{ marginBottom: "100px" }}>
        ...
        <UL>
          ...
          <li>
            Connect with the DevOps teams to deploy into the cloud using Docker,
            Team Cities, and AWS.
          </li>
          <li>
            Assist other developers with understanding and contributing features
        ...
        <UL>
          ...
          <li>
            ...
            Manage environment configurations for database migrations after API
            launch.
          </li>
        </UL>
        ...
        <UL>
          ...
          <li>
            ...
            payments, assist with cash projections and resolve other accounting
            issues.
          </li>
        </UL>
        ...
        <UL>
          <li>
            AR duties included collections and cash application. Monitored aging
            reports to follow-up on delinquent accounts or old invoices or
            credits. Worked with the sales team and customer service to resolve
            billing or claims discrepancies.
          </li>
        </UL>
        ...
        <P>
          ...
          exhibitions for leading arts publications, including Frieze, FlashArt,
          and Artillery.{" "}
        </P>
        <P>
