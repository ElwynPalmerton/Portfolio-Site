  ...
  return (
    <PageWrapper>
      <div style={{ marginBottom: "100px" }}>
        <h2 className="sample">Full-Stack Web Apps</h2>
        <Grid style={{ marginTop: "30px" }} container spacing={10}>
          {constants.map((content, i) => {
            return (
              <Grid key={i} item xs={12} sm={6}>
                <JunkCard product={content} />
              </Grid>
            );
          })}
        </Grid>

        <h2 style={{ marginTop: "60px" }} className="sample">
          Animations
        </h2>
        <Grid
          alignItems="stretch"
